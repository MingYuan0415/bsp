#ifndef __RTC_FAKE_I2C_MASTER_H__
#define __RTC_FAKE_I2C_MASTER_H__
...
typedef struct fake_rtc_i2c_bus *i2c_master_bus_handle_t;
typedef struct fake_rtc_i2c_device *i2c_master_dev_handle_t;
...
#endif /* __RTC_FAKE_I2C_MASTER_H__ */
