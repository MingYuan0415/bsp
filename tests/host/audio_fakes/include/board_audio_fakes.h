...
typedef struct board_audio_fake_state
{
    ...
    unsigned i2s_get_info_calls;
    unsigned i2s_disable_calls;
    unsigned i2s_disable_failures_remaining;
    unsigned i2s_read_calls;
    unsigned i2s_delete_calls;
    unsigned i2s_delete_failures_remaining;
    unsigned data_create_calls;
    unsigned data_delete_calls;
    unsigned codec_create_calls;
    unsigned codec_delete_calls;
    unsigned codec_open_calls;
    unsigned codec_close_calls;
    unsigned codec_set_in_gain_calls;
    unsigned codec_open_failures_remaining;
    unsigned codec_close_failures_remaining;
    unsigned codec_set_in_gain_failures_remaining;
    bool codec_opened;
    bool codec_open_leave_rx_disabled;
    bool codec_close_leave_tx_enabled;
    bool i2s_auto_clear_after_cb;
    bool i2s_allocated[BOARD_AUDIO_FAKE_CHANNEL_COUNT];
    bool i2s_enabled[BOARD_AUDIO_FAKE_CHANNEL_COUNT];
